...
public class user_retrieve_spare_parts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter= new FirebaseRecyclerAdapter<spareparts, MyViewHolder3>(options) {
            ...
            public MyViewHolder3 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.spare_parts_layout,parent,false);
